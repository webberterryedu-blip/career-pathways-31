...
async def run_test():
    ...
    try:
        ...
        # Click on 'Estudantes' button to go to students page.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/main/div/div/div[2]/div/div/div/div/div[2]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click 'Editar' button for the first student (Frank Lima) to open student details and access family members management.
        frame = context.pages[-1]
