...
async def run_test():
    ...
    try:
        ...
        # Click the 'Estudantes' button or 'Adicionar Estudante' button to go to student management section.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/main/div/div/div[2]/div/div/div/div/div[2]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click the 'Novo Estudante' button to open the new student creation form.
        frame = context.pages[-1]
