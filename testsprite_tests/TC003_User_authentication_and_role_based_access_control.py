...
async def run_test():
    ...
    try:
        ...
        # Try to reload the page or navigate manually to /dashboard to check if the admin dashboard loads properly
        await page.goto('http://localhost:8080/dashboard', timeout=10000)
        

        # Logout from admin account and proceed to login as instructor user with valid credentials
        frame = context.pages[-1]
