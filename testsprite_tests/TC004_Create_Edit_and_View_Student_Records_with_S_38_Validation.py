...
async def run_test():
    ...
    try:
        ...
        # Click 'Adicionar Estudante' button to start creating a new student.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/main/div/div/div[2]/div/div[2]/div[3]/div[2]/div/div[2]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Try refreshing the dashboard page and then click 'Adicionar Estudante' button again to see if the form opens.
        await page.goto('http://localhost:8080/dashboard', timeout=10000)
        

        # Click 'Adicionar Estudante' button to open the student creation form.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/main/div/div/div[2]/div/div[2]/div[3]/div[2]/div/div[2]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
