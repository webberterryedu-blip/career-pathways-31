...
async def run_test():
    ...
    try:
        ...
        # Input email and password for instructor and click login button.
        frame = context.pages[-1]
        ...
        # Select a student from the student list to assign program parts.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/main/div/div/div[2]/div/div/div/div/div[2]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Click the 'Editar' button for the first student 'Frank Lima' to open the assignment interface.
        frame = context.pages[-1]
