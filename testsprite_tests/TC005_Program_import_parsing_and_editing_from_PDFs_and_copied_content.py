...
async def run_test():
    ...
    try:
        ...
        # Click on 'Entrar' (Login) button to start login process.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/header/div/div/div[3]/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Input email and password, then click 'Entrar' button to login as instructor.
        frame = context.pages[-1]
        ...
        # Try to reload the page or navigate back to the homepage to attempt navigation to program management again.
        await page.goto('http://localhost:8080/', timeout=10000)
        

        # Click on 'Entrar' button to login again as instructor.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/section[3]/div/div[3]/div/div/div/button[2]').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
