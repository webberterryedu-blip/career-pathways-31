...
async def run_test():
    ...
    try:
        ...
        # Simulate going offline by disconnecting network or using browser offline mode via automation commands.
        frame = context.pages[-1]
        elem = frame.locator('xpath=html/body/div/div/div/div/main/div/div/div[2]/div/div/div/div/div[2]/button').nth(0)
        await page.wait_for_timeout(3000); await elem.click(timeout=5000)
        

        # Simulate going offline by disconnecting network or using browser automation commands to toggle offline mode.
        frame = context.pages[-1]
